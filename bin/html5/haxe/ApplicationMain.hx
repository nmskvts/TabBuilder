...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TabBuilder", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TabBuilder", null, 800, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "153";
		app.meta["company"] = "Anastasia";
		app.meta["file"] = "TabBuilder";
		app.meta["name"] = "TabBuilder";
		app.meta["packageName"] = "TabBuilder";
		...
		#elseif !air
		app.window.context.attributes.background = -1;
