...
HXLINE( 275)				_hx_tmp2 = (rect->y > this->y);
            			}
            			else {
HXLINE( 275)				_hx_tmp2 = false;
            			}
HXDLIN( 275)			if (_hx_tmp2) {
HXLINE( 275)				Float _hx_tmp3 = rect->get_right();
HXDLIN( 275)				_hx_tmp1 = (_hx_tmp3 < this->get_right());
            			}
            			else {
HXLINE( 275)				_hx_tmp1 = false;
            			}
HXDLIN( 275)			if (_hx_tmp1) {
HXLINE( 275)				Float _hx_tmp4 = rect->get_bottom();
HXDLIN( 275)				return (_hx_tmp4 < this->get_bottom());
            			}
            			else {
...
HXLINE( 279)			bool _hx_tmp5;
HXDLIN( 279)			bool _hx_tmp6;
HXDLIN( 279)			if ((rect->x >= this->x)) {
HXLINE( 279)				_hx_tmp6 = (rect->y >= this->y);
            			}
            			else {
HXLINE( 279)				_hx_tmp6 = false;
            			}
HXDLIN( 279)			if (_hx_tmp6) {
HXLINE( 279)				Float _hx_tmp7 = rect->get_right();
HXDLIN( 279)				_hx_tmp5 = (_hx_tmp7 <= this->get_right());
            			}
            			else {
HXLINE( 279)				_hx_tmp5 = false;
            			}
HXDLIN( 279)			if (_hx_tmp5) {
HXLINE( 279)				Float _hx_tmp8 = rect->get_bottom();
HXDLIN( 279)				return (_hx_tmp8 <= this->get_bottom());
            			}
            			else {
...
HXLINE( 530)				_hx_tmp1 = (toUnion->height == 0);
            			}
            			else {
