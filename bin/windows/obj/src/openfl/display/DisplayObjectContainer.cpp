...
HXLINE( 198)			HX_STACK_DO_THROW(error);
            		}
            		else {
HXLINE( 201)			if (hx::IsEq( child->stage,child )) {
HXLINE( 203)				 ::openfl::errors::ArgumentError error1 =  ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("Error #3783: A Stage object cannot be added as the child of another object.",fa,51,93,42));
HXLINE( 204)				error1->errorID = 3783;
HXLINE( 205)				HX_STACK_DO_THROW(error1);
            			}
            		}
...
HXLINE( 211)			HX_STACK_DO_THROW((HX_("Invalid index position ",80,59,50,86) + index));
            		}
...
HXLINE( 456)					_hx_tmp1 = hx::IsEq( this->stage->get_focus(),child );
            				}
            				else {
...
HXLINE( 461)				 ::openfl::events::Event event1 =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removedFromStage",34,21,76,ba),false,false);
HXLINE( 462)				child->_hx___dispatchWithCapture(event1);
HXLINE( 463)				child->_hx___dispatchChildren(event1);
...
HXLINE( 537)				HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,HX_("The supplied index is out of bounds.",17,96,1b,51)));
            			}
            		}
...
HXLINE( 787)				_hx_tmp2 = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE( 788)		bool _hx_tmp3;
HXDLIN( 788)		if (hx::IsNotNull( this->get_mask() )) {
HXLINE( 788)			_hx_tmp3 = !(this->get_mask()->_hx___hitTestMask(x,y));
            		}
            		else {
HXLINE( 788)			_hx_tmp3 = false;
            		}
HXDLIN( 788)		if (_hx_tmp3) {
...
HXLINE( 808)				_hx_tmp4 = !(this->mouseChildren);
            			}
            			else {
HXLINE( 808)				_hx_tmp4 = true;
            			}
...
HXLINE( 840)								bool _hx_tmp6;
HXDLIN( 840)								if (interactive) {
HXLINE( 840)									_hx_tmp6 = (stack->length > length);
            								}
            								else {
HXLINE( 840)									_hx_tmp6 = false;
            								}
HXDLIN( 840)								if (_hx_tmp6) {
...
HXLINE( 857)			bool hitTest1 = false;
...
HXDLIN( 927)			::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN( 927)			while((_g2 < _g11->length)){
HXLINE( 927)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 927)				_g2 = (_g2 + 1);
HXLINE( 929)				child1->_hx___renderCairo(renderer);
            			}
            		}
...
HXLINE( 979)			int _g2 = 0;
HXDLIN( 979)			::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN( 979)			while((_g2 < _g11->length)){
HXLINE( 979)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 979)				_g2 = (_g2 + 1);
HXLINE( 981)				child1->_hx___renderCanvas(renderer);
            			}
            		}
...
HXLINE(1014)		{
HXLINE(1014)			{
HXLINE(1014)				 ::Dynamic orphan2 = this->_hx___removedChildren->iterator();
HXDLIN(1014)				while(( (bool)(orphan2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(1014)					 ::openfl::display::DisplayObject orphan3 = ( ( ::openfl::display::DisplayObject)(orphan2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXDLIN(1014)					if (hx::IsNull( orphan3->stage )) {
HXLINE(1014)						orphan3->_hx___cleanup();
            					}
            				}
            			}
...
HXLINE(1034)			int _g2 = 0;
HXDLIN(1034)			::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN(1034)			while((_g2 < _g11->length)){
HXLINE(1034)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1034)				_g2 = (_g2 + 1);
HXLINE(1036)				child1->_hx___renderDOM(renderer);
            			}
            		}
...
HXLINE(1053)		{
HXLINE(1053)			{
HXLINE(1053)				 ::Dynamic orphan2 = this->_hx___removedChildren->iterator();
HXDLIN(1053)				while(( (bool)(orphan2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(1053)					 ::openfl::display::DisplayObject orphan3 = ( ( ::openfl::display::DisplayObject)(orphan2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXDLIN(1053)					if (hx::IsNull( orphan3->stage )) {
HXLINE(1053)						orphan3->_hx___cleanup();
            					}
            				}
            			}
...
HXLINE(1088)				int _g2 = 0;
HXDLIN(1088)				::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN(1088)				while((_g2 < _g11->length)){
HXLINE(1088)					 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1088)					_g2 = (_g2 + 1);
HXLINE(1090)					child1->_hx___renderGL(renderer);
            				}
            			}
            		}
