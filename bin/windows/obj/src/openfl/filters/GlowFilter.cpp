...
HXLINE( 270)			Float scale1 = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));
HXLINE( 271)			::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 272)			::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value[1] = (this->get_blurY() * scale1);
            		}
