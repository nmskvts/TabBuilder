...
HXLINE( 204)			Float scale1 = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));
HXLINE( 205)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 206)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[1] = (this->get_blurY() * scale1);
            		}
