...
HXLINE( 234)									 ::openfl::_internal::text::TextFormatRange _hx_tmp6 = textFormatRanges->get((textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXDLIN( 234)									_hx_tmp6->end++;
            								}
            							}
            						}
            						else {
HXLINE( 239)							textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,format,value.length,(value.length + segment1.length)));
