...
HXDLIN( 608)				{
HXLINE( 608)					int _g11 = 0;
HXDLIN( 608)					::Array< ::Dynamic> _g21 = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 608)					while((_g11 < _g21->length)){
HXLINE( 608)						 ::haxe::Timer v = _g21->__get(_g11).StaticCast<  ::haxe::Timer >();
HXDLIN( 608)						_g11 = (_g11 + 1);
