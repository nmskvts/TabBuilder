...
HXLINE(2299)						{
HXLINE(2299)							int _g1 = 0;
HXDLIN(2299)							int _g2 = bools;
HXDLIN(2299)							while((_g1 < _g2)){
HXLINE(2299)								_g1 = (_g1 + 1);
HXDLIN(2299)								int i = (_g1 - 1);
...
HXLINE(2308)										 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
HXDLIN(2308)										::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN(2308)										_this1->byteOffset = 0;
HXDLIN(2308)										_this1->length = array1->get_length();
HXDLIN(2308)										_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(2308)										 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(2308)										_this1->buffer = this3;
HXDLIN(2308)										_this1->copyFromArray(array1,null());
HXDLIN(2308)										this1 = _this1;
            									}
            									else {
HXLINE(2308)										if (hx::IsNotNull( view )) {
HXLINE(2308)											 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXDLIN(2308)											int elementSize = _this2->bytesPerElement;
HXDLIN(2308)											if ((view->type == _this2->type)) {
HXLINE(2308)												int srcLength1 = srcData->length;
HXDLIN(2308)												int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(2308)												 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(2308)												_this2->buffer = this4;
HXDLIN(2308)												_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            											}
            											else {
HXLINE(2308)												HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            											}
HXDLIN(2308)											_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(2308)											_this2->byteOffset = 0;
HXDLIN(2308)											_this2->length = srcLength;
HXDLIN(2308)											this1 = _this2;
            										}
            										else {
HXLINE(2308)											if (hx::IsNotNull( buffer )) {
HXLINE(2308)												 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXDLIN(2308)												if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(2308)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN(2308)												int bufferByteLength = buffer->length;
HXDLIN(2308)												int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(2308)													if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(2308)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
...
HXLINE(2308)													newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(2308)													int newRange = (in_byteOffset + newByteLength);
HXDLIN(2308)													if ((newRange > bufferByteLength)) {
HXLINE(2308)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
            												}
HXDLIN(2308)												_this3->buffer = buffer;
HXDLIN(2308)												_this3->byteOffset = in_byteOffset;
HXDLIN(2308)												_this3->byteLength = newByteLength;
HXDLIN(2308)												_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(2308)												this1 = _this3;
            											}
            											else {
HXLINE(2308)												HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Int32Array",9b,2e,53,61));
            											}
            										}
            									}
            								}
            							}
HXDLIN(2308)							 ::lime::utils::ArrayBufferView params1 = this1;
HXLINE(2309)							this->getUniformiv(program,location,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromArrayBufferView(params1));
HXLINE(2310)							return params1;
            						}
            						else {
HXLINE(2312)							if ((floats > 0)) {
HXLINE(2314)								 ::haxe::io::Bytes buffer1 = null();
HXDLIN(2314)								::cpp::VirtualArray array2 = null();
HXDLIN(2314)								 ::openfl::_Vector::FloatVector vector1 = null();
HXDLIN(2314)								 ::lime::utils::ArrayBufferView view1 = null();
HXDLIN(2314)								 ::Dynamic len1 = null();
HXDLIN(2314)								 ::lime::utils::ArrayBufferView this5;
HXDLIN(2314)								if (hx::IsNotNull( floats )) {
HXLINE(2314)									this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,floats,8);
            								}
            								else {
HXLINE(2314)									if (hx::IsNotNull( array2 )) {
HXLINE(2314)										 ::lime::utils::ArrayBufferView _this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(2314)										_this4->byteOffset = 0;
HXDLIN(2314)										_this4->length = array2->get_length();
HXDLIN(2314)										_this4->byteLength = (_this4->length * _this4->bytesPerElement);
HXDLIN(2314)										 ::haxe::io::Bytes this6 = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN(2314)										_this4->buffer = this6;
HXDLIN(2314)										_this4->copyFromArray(array2,null());
HXDLIN(2314)										this5 = _this4;
            									}
            									else {
HXLINE(2314)										if (hx::IsNotNull( vector1 )) {
HXLINE(2314)											 ::lime::utils::ArrayBufferView _this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(2314)											::cpp::VirtualArray array3 = ( (::cpp::VirtualArray)(vector1->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN(2314)											_this5->byteOffset = 0;
HXDLIN(2314)											_this5->length = array3->get_length();
HXDLIN(2314)											_this5->byteLength = (_this5->length * _this5->bytesPerElement);
HXDLIN(2314)											 ::haxe::io::Bytes this7 = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN(2314)											_this5->buffer = this7;
HXDLIN(2314)											_this5->copyFromArray(array3,null());
HXDLIN(2314)											this5 = _this5;
            										}
            										else {
HXLINE(2314)											if (hx::IsNotNull( view1 )) {
HXLINE(2314)												 ::lime::utils::ArrayBufferView _this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(2314)												 ::haxe::io::Bytes srcData1 = view1->buffer;
HXDLIN(2314)												int srcLength2 = view1->length;
HXDLIN(2314)												int srcByteOffset1 = view1->byteOffset;
HXDLIN(2314)												int srcElementSize1 = view1->bytesPerElement;
HXDLIN(2314)												int elementSize2 = _this6->bytesPerElement;
HXDLIN(2314)												if ((view1->type == _this6->type)) {
HXLINE(2314)													int srcLength3 = srcData1->length;
HXDLIN(2314)													int cloneLength1 = (srcLength3 - srcByteOffset1);
HXDLIN(2314)													 ::haxe::io::Bytes this8 = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN(2314)													_this6->buffer = this8;
HXDLIN(2314)													_this6->buffer->blit(0,srcData1,srcByteOffset1,cloneLength1);
            												}
            												else {
HXLINE(2314)													HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            												}
HXDLIN(2314)												_this6->byteLength = (_this6->bytesPerElement * srcLength2);
HXDLIN(2314)												_this6->byteOffset = 0;
HXDLIN(2314)												_this6->length = srcLength2;
HXDLIN(2314)												this5 = _this6;
            											}
            											else {
HXLINE(2314)												if (hx::IsNotNull( buffer1 )) {
HXLINE(2314)													 ::lime::utils::ArrayBufferView _this7 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(2314)													int in_byteOffset1 = 0;
HXDLIN(2314)													if ((in_byteOffset1 < 0)) {
HXLINE(2314)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
HXDLIN(2314)													if ((hx::Mod(in_byteOffset1,_this7->bytesPerElement) != 0)) {
HXLINE(2314)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
HXDLIN(2314)													int bufferByteLength1 = buffer1->length;
HXDLIN(2314)													int elementSize3 = _this7->bytesPerElement;
HXDLIN(2314)													int newByteLength1 = bufferByteLength1;
HXDLIN(2314)													if (hx::IsNull( len1 )) {
HXLINE(2314)														newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN(2314)														if ((hx::Mod(bufferByteLength1,_this7->bytesPerElement) != 0)) {
HXLINE(2314)															HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            														}
HXDLIN(2314)														if ((newByteLength1 < 0)) {
HXLINE(2314)															HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            														}
            													}
            													else {
HXLINE(2314)														newByteLength1 = (( (int)(len1) ) * _this7->bytesPerElement);
HXDLIN(2314)														int newRange1 = (in_byteOffset1 + newByteLength1);
HXDLIN(2314)														if ((newRange1 > bufferByteLength1)) {
HXLINE(2314)															HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            														}
            													}
HXDLIN(2314)													_this7->buffer = buffer1;
HXDLIN(2314)													_this7->byteOffset = in_byteOffset1;
HXDLIN(2314)													_this7->byteLength = newByteLength1;
HXDLIN(2314)													_this7->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this7->bytesPerElement) )));
HXDLIN(2314)													this5 = _this7;
            												}
            												else {
HXLINE(2314)													HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            												}
            											}
            										}
            									}
            								}
HXDLIN(2314)								 ::lime::utils::ArrayBufferView params2 = this5;
HXLINE(2315)								this->getUniformfv(program,location,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromArrayBufferView(params2));
HXLINE(2316)								return params2;
            							}
            							else {
