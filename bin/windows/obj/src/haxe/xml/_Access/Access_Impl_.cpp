...
bool Access_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x620cedbe;
}
...
HXDLIN( 216)		 ::Dynamic it = this1->children->iterator();
HXLINE( 217)		if (!(( (bool)(it->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) ))) {
...
HXLINE( 219)		 ::Xml v = ( ( ::Xml)(it->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 220)		if (( (bool)(it->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )) {
HXLINE( 221)			 ::Xml n = ( ( ::Xml)(it->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 224)				if (!(( (bool)(it->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) ))) {
...
HXLINE( 226)				 ::Xml n2 = ( ( ::Xml)(it->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 227)					_hx_tmp6 = !(( (bool)(it->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) ));
            				}
            				else {
