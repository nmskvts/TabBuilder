...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TabBuilder",66,d1,43,28),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Anastasia",1f,cc,95,ea));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TabBuilder",66,d1,43,28));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TabBuilder",66,d1,43,28));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("TabBuilder",66,d1,43,28));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TabBuilder",66,d1,43,28))
...
HXLINE(  66)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),-1)
